...
export function analyzeHistorically(option: TerminalOption): AnalystVerdict {
  ...
  const howAlMap: Record<AnalystVerdict["action"], string> = {
    "BUY CALL": `1. Zgjidhni Call me Strike afër ATM (Delta 0.45-0.60) dhe DTE 30-45. 2. Hyni me madhësi pozicioni ${macro.positionScale} (ose më të vogël). 3. Vendosni Stop Loss nëse çmimi bie 15-20% nga premium. 4. Merreni fitimin nëse opsioni bëhet 2x premiumi. 5. Mbyllni para skadimit javën e fundit (rrezik gamma).`,
    "SELL CALL": `1. Sigurohuni që keni 100 aksione për covered call (ose përdorni spread). 2. Zgjidhni Strike OTM 5-10% mbi çmimin aktual. 3. DTE 30-45 për ekuilibër midis premium dhe rrezikut. 4. Mbyllni nëse aksioni ngrihet afër Strike. 5. Mos e shitni Call pa mbulim (naked) — rrezik i pakufizuar.`,
    "BUY PUT": `1. Zgjidhni Put me Strike afër ATM (Delta -0.45 deri -0.60) dhe DTE 30-45. 2. Hyni me madhësi ${macro.positionScale}. 3. Vendosni Stop Loss nëse çmimi nuk bie brenda 7-10 ditëve. 4. Merreni fitimin nëse opsioni bëhet 2x premiumi. 5. Përdorni Put Debit Spread për të ulur rrezikun.`,
    "SELL PUT": `1. Sigurohuni që keni kapital për 100 aksione (cash-secured). 2. Zgjidhni Strike OTM 5-10% nën çmimin aktual. 3. DTE 30-45. 4. Nëse aksioni bie nën Strike, blini me zbritje. 5. Nëse aksioni qëndron mbi Strike, mbani premiumin (fitim 100%). 6. Përdorni Put Credit Spread për rrezik të përcaktuar.`,
    ...
    "AVOID": `1. Mos hyni në asnjë pozicion me këtë aksion tani. 2. Prisni derisa Data Quality të kalojë 60+. 3. Kontrolloni përsëri pas ditës tjetër të tregtimit. 4. Nëse duhet ekspozim në sektor, kërkoni aksion me Score më të lartë. 5. Konsideroni aksion të ngjashëm me cilësi më të mirë të dhënash.`
  };
